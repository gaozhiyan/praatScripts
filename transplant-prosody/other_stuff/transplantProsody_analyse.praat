Read Table from comma-separated file: "auto_pitch.csv"
...
writeFileLine: "descriptive_data.csv", "stimulus_name,speech_rate,pitch_mean,pitch_sd,FL_ratio,AL_ratio,combined_ratio"

for combo to num_combos
	selectObject: "Table auto_pitch"
...
procedure writeDescriptiveData
	...
	@getPitch
	@getRhythm
	appendFileLine: "descriptive_data.csv", new_name$, ",", getSpeechRate.rate, ",", getPitch.mean_erb, ",", getPitch.sd_erb, ",", getRhythm.fl_ratio, ",", getRhythm.al_ratio, ",", getRhythm.comb_ratio
endproc
...
procedure getPitch
	...
	Extract pitch tier
	.sd_hz = Get standard deviation (curve): start_sound, end_sound
	.sd_erb = 16.7 * log10(1 + .sd_hz / 165.4)
	.mean_hz = Get mean (curve): start_sound, end_sound
